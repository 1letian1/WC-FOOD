...
public class CategoryConverter {
    ...
    public com.shike.ordering.vo.merchant.CategoryVO toMerchantVO(Category category) {
        EnabledStatus status = category.getStatus() == 1 ? EnabledStatus.ENABLED : EnabledStatus.DISABLED;
        return new com.shike.ordering.vo.merchant.CategoryVO(category.getId(), category.getName(),
                new StatusVO(status.getCode(), status.getDescription()), category.getSort());
    }
}
